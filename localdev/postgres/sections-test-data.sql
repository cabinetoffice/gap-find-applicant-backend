...
-- Sections not started and fails on not receiving responses to mandatory questions.
      ...
      "questions": [
        {
          ...
          "hintText": "Some admin supplied text describing what it means to be eligible to apply for this grant",          "responseType": "ShortAnswer",
    ...
    },
    {
      ...
      "questions": [
        ...
        },
        {
          ...
          "fieldTitle": "Description of the project, please include information public accessibility (see GOV.UK guidance for a definition of public access)",
        ...
        },
        {
          ...
          "fieldTitle": "Select from the following options",
          "hintText": "Funding organisation might use this to identify your organisation when you apply for a grant. It might also be used to check your organisation is legitimate.",
